...
function saveLinkInfo($key_verse, $title, $language, $filename, $brand = 'Our-Daily-Bread') {
    if (empty($key_verse)) {
        return false;
    }
...
function deleteLinkInfo($key_verse, $language, $filename, $brand = 'Our-Daily-Bread') {
...
if ($is_logged_in || true) {
    ...
    if ($action === 'add' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Save link information - brand is 'Our-Daily-Bread' for this admin panel
        saveLinkInfo($_POST['key_verse'], $_POST['title'], $language, $filename, 'Our-Daily-Bread');
    ...
    if ($action === 'delete') {
        ...
        if (file_exists($file)) {
            ...
            if (!empty($meditation_data['key_verse'])) {
                deleteLinkInfo($meditation_data['key_verse'], $language, $filename, 'Our-Daily-Bread');
            }
...
<head>
    ...
    <title>Admin Panel - Our Daily Bread</title>
    ...
    <meta name="apple-mobile-web-app-title" content="Admin - Our Daily Bread">
                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" id="meditationForm" class="admin-form">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- Quote Section - Hidden for Our-Daily-Bread -->
                                ...
                                <!-- Recommended Book Section - Hidden for Our-Daily-Bread -->
                                <div style="display: none;">
                                ...
                                <!-- Conclusion Section - Hidden for Our-Daily-Bread -->
                                <div style="display: none;">
