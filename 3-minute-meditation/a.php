...
function deleteLinkInfo($key_verse, $language, $filename, $brand = '3-minute-meditation') {
    ...
    if ($action === 'delete') {
        ...
        if (file_exists($file)) {
            ...
            if (!empty($meditation_data['key_verse'])) {
                deleteLinkInfo($meditation_data['key_verse'], $language, $filename, '3-minute-meditation');
            }
