...
function saveLinkInfo($key_verse, $title, $language, $filename, $brand = 'நாளுக்கொரு-நல்ல-பங்கு') {
    if (empty($key_verse)) {
        return false;
    }
...
function deleteLinkInfo($key_verse, $language, $filename, $brand = 'நாளுக்கொரு-நல்ல-பங்கு') {
...
if ($is_logged_in || true) {
    ...
    if ($action === 'add' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Save link information - brand is 'நாளுக்கொரு-நல்ல-பங்கு' for this admin panel
        saveLinkInfo($_POST['key_verse'], $_POST['title'], $language, $filename, 'நாளுக்கொரு-நல்ல-பங்கு');
    ...
    if ($action === 'delete') {
        ...
        if (file_exists($file)) {
            ...
            if (!empty($meditation_data['key_verse'])) {
                deleteLinkInfo($meditation_data['key_verse'], $language, $filename, 'நாளுக்கொரு-நல்ல-பங்கு');
            }
...
<head>
    ...
    <title>Admin Panel - நாளுக்கொரு நல்ல பங்கு</title>
    ...
    <meta name="apple-mobile-web-app-title" content="Admin - நாளுக்கொரு நல்ல பங்கு">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark admin-navbar">
        <div class="container">
            <a class="navbar-brand fw-bold" href="../index.php">
                <i class="bi bi-shield-lock me-2"></i>Admin Panel - நாளுக்கொரு நல்ல பங்கு
            </a>
                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" id="meditationForm" class="admin-form">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- Quote Section - Hidden for நாளுக்கொரு-நல்ல-பங்கு -->
                                ...
                                <!-- Recommended Book Section - Hidden for நாளுக்கொரு-நல்ல-பங்கு -->
                                <div style="display: none;">
                                ...
                                <!-- Conclusion Section - Hidden for நாளுக்கொரு-நல்ல-பங்கு -->
                                <div style="display: none;">
