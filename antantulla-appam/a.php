...
function saveLinkInfo($key_verse, $title, $language, $filename, $brand = 'antantulla-appam') {
    if (empty($key_verse)) {
        return false;
    }
...
function deleteLinkInfo($key_verse, $language, $filename, $brand = 'antantulla-appam') {
...
if ($is_logged_in || true) {
    ...
    if ($action === 'add' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Save link information - brand is 'antantulla-appam' for this admin panel
        saveLinkInfo($_POST['key_verse'], $_POST['title'], $language, $filename, 'antantulla-appam');
    ...
    if ($action === 'delete') {
        ...
        if (file_exists($file)) {
            ...
            if (!empty($meditation_data['key_verse'])) {
                deleteLinkInfo($meditation_data['key_verse'], $language, $filename, 'antantulla-appam');
            }
...
<head>
    ...
    <title>Admin Panel - Antantulla Appam</title>
    ...
    <meta name="apple-mobile-web-app-title" content="Admin - Antantulla Appam">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark admin-navbar">
        <div class="container">
            <a class="navbar-brand fw-bold" href="../index.php">
                <i class="bi bi-shield-lock me-2"></i>Admin Panel - Antantulla Appam
            </a>
                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" id="meditationForm" class="admin-form">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- Quote Section - Hidden for antantulla-appam -->
                                ...
                                <!-- Recommended Book Section - Hidden for antantulla-appam -->
                                <div style="display: none;">
                                ...
                                <!-- Song Section (Optional) - Hidden for antantulla-appam -->
                                <div style="display: none;">
                                ...
                                <!-- Prayer Section - Hidden for antantulla-appam -->
                                <div style="display: none;">
                                ...
                                <!-- Conclusion Section - Hidden for antantulla-appam -->
                                <div style="display: none;">
                                ...
                                <!-- Author Contact Fields - Hidden for antantulla-appam -->
                                <div style="display: none;">
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="admin-form-group">
