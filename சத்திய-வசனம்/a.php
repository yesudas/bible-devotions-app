...
function saveLinkInfo($key_verse, $title, $language, $filename, $brand = 'சத்திய-வசனம்') {
    if (empty($key_verse)) {
        return false;
    }
...
function deleteLinkInfo($key_verse, $language, $filename, $brand = 'சத்திய-வசனம்') {
...
if ($is_logged_in || true) {
    ...
    if ($action === 'add' && $_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        // Save link information - brand is 'சத்திய-வசனம்' for this admin panel
        saveLinkInfo($_POST['key_verse'], $_POST['title'], $language, $filename, 'சத்திய-வசனம்');
    ...
    if ($action === 'delete') {
        ...
        if (file_exists($file)) {
            ...
            if (!empty($meditation_data['key_verse'])) {
                deleteLinkInfo($meditation_data['key_verse'], $language, $filename, 'சத்திய-வசனம்');
            }
...
<head>
    ...
    <title>Admin Panel - சத்திய வசனம்</title>
    ...
    <meta name="apple-mobile-web-app-title" content="Admin - சத்திய வசனம்">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark admin-navbar">
        <div class="container">
            <a class="navbar-brand fw-bold" href="../index.php">
                <i class="bi bi-shield-lock me-2"></i>Admin Panel - சத்திய வசனம்
            </a>
                    ...
                    <div class="modal-content">
                        ...
                        <form method="POST" id="meditationForm" class="admin-form">
                            ...
                            <div class="modal-body">
                                ...
                                <!-- Quote Section - Hidden for சத்திய-வசனம் -->
                                ...
                                <!-- Recommended Book Section - Hidden for சத்திய-வசனம் -->
                                <div style="display: none;">
                                ...
                                <!-- Conclusion Section - Hidden for சத்திய-வசனம் -->
                                <div style="display: none;">
