...
function getAppName($language) {
    ...
    return "Bible Minutes"; // Default fallback
}
...
$mode = $_GET['mode'] ?? 'latest';
$action = $_GET['action'] ?? '';
$uniqueid = $_GET['id'] ?? null; // Changed from 'index' to 'id' for uniqueid
...
<body>
    ...
    <div class="site-header">
        <div class="container">
            <h1><i class="bi bi-clock"></i> <?php echo htmlspecialchars($appName); ?></h1>
            <p class="site-tagline">A Devotional Journey Through the Bible, Verse by Verse</p>
                        ...
                        <?php foreach ($languages as $lang): ?>
                            <li>
                                <a class="dropdown-item <?php echo $lang === $selectedLanguage ? 'active' : ''; ?>" 
                                   href="?lang=<?php echo urlencode($lang); ?><?php echo isset($_GET['mode']) ? '&mode=' . htmlspecialchars($_GET['mode']) : ''; ?><?php echo isset($_GET['index']) ? '&index=' . htmlspecialchars($_GET['index']) : ''; ?><?php echo isset($_GET['view']) ? '&view=' . htmlspecialchars($_GET['view']) : ''; ?>">
            ...
            <?php else: ?>
                ...
                <?php if ($meditation): ?>
                    ...
                    <div class="devotion-content fade-in">
                        ...
                        <?php if (!empty($meditation['song']['text'])): ?>
                        <div class="section">
                        ...
                        <?php if (!empty($meditation['prayer']['text'])): ?>
                        <div class="section">
                        ...
                        <div class="section">
                            ...
                            <?php if (!empty($meditation['author']['whatsapp'])): ?>
                                <p class="mb-1">
                                    ...
                                    <a href="https://wa.me/<?php echo preg_replace('/[^0-9]/', '', $meditation['author']['whatsapp']); ?>?text=Bible-Minutes"
                    ...
                    <div class="navigation">
                        ...
                        if ($currentIndex !== null) {
                            ...
                            $prevUniqueId = isset($allMeditations[$prevIndex]) ? $allMeditations[$prevIndex]['uniqueid'] : '';
                            $nextUniqueId = isset($allMeditations[$nextIndex]) ? $allMeditations[$nextIndex]['uniqueid'] : '';
                        ?>
        ...
        <div class="container">
            ...
            <div class="footer-section">
                ...
                <p class="mb-0">
                    ...
                    <a href="https://wa.me/917676505599?text=Bible-Minutes-App" class="footer-link">+91 7676505599</a>
                </p>
            </div>
